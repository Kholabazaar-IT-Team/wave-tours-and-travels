                                          ...
                                          <div id="testimonial_slider" class="carousel slide" data-ride="carousel">
                                             ...
                                             <div class="carousel-inner">
                                                <div class="item carousel-item active">
                                                   <div class="img-box"><img src="{{asset('uploads/layout_img/user_img.jpg')}}" alt=""></div>
                           ...
                           <div class="dash_blog">
                              <div class="dash_blog_inner">
                                 ...
                                 <div class="msg_list_main">
                                    <ul class="msg_list">
                                       <li>
                                          <span><img src="{{asset('uploads/layout_img/msg2.png')}}" class="img-responsive" alt="#" /></span>
                                          <span>
                                       ...
                                       <li>
                                          <span><img src="{{asset('uploads/layout_img/msg3.png')}}" class="img-responsive" alt="#" /></span>
                                          <span>
